...
public class Registrieren extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditText passwortReg = findViewById(R.id.passwordInput);
        EditText passwortWhReg = findViewById(R.id.passwordRepeatInput);
        Button bestätigenReg = findViewById(R.id.registerButton);

        benutzerDAO = RoomDatenbank.getInstance(getApplicationContext()).userDao();

        bestätigenReg.setOnClickListener(new View.OnClickListener() {
            @Override
